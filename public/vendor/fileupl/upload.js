    ...
    $('#upload').fileupload({
        ...
        fail:function(e, data){
            ...
            $("#sortable").prepend('<li draggable="true" id="photo_'+ids[1]+'" class="img">'
                ...
                + '</td>'
                + '<td class="img-edit">'
                + '<a class="title_save" data-photoid="'+ids[1]+'"><span class="glyphicon flaticon"><img src="/public/img/admin/check13.png"></span></a>'
                + '</td>'
                + '<td class="img-edit">'
                + '<a class="title_cancel" data-photoid="'+ids[1]+'"><span class="glyphicon flaticon"><img src="/public/img/admin/close11.png"></span></a>'
                + '</td>'
                + '<td class="img-add">'
                + '<a class="title_edit" data-photoid="'+ids[1]+'"><span class="glyphicon flaticon"><img src="/public/img/admin/note6.png"></span></a>'
                + '</td>'
                + '</tr>'
                + '</table>'
                + ' </div></li>');
