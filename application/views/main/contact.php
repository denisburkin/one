<div class="container">
	<div class="row">
		<div class="col-md-12" style="padding-bottom: 100px;font-size: 16px;">
			...
			<div class="accordion">
				<dl>
					...
					<? foreach ($pages as $row): ?>
						...
						<dt><a class="accordionTitle" href="#"><?= $row->{((lang == 'ru') ? 'title' : 'title_en')} ?></a></dt>
						<dd class="accordionItem accordionItemCollapsed">
							<?= $row->{((lang == 'ru') ? 'content' : 'content_en')} ?>
						</dd>
